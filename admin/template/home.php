 <!--sidebar end-->
    ...
    <div class="col-lg-9">
        ...
        <!-- Menambahkan Gambar di bawah Dashboard -->
        <div style="display: flex; justify-content: center; align-items: center; margin-top: 90px;">
    <img src="assets/img/pic/gbr1.png" alt="Deskripsi Gambar" style="width: 500%; max-width: 900px; height: auto; object-fit: cover; margin: 90;">
</div>
    </div>
</div>
